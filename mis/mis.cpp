...
hittable_list cornell_box()
{
    ...
    auto glossy1 = make_shared<metal_ggx>(vec3(1, 1, 1), 0.00001);
    ...
    auto glossy2 = make_shared<metal_ggx>(vec3(1, 1, 1), 0.25);
    ...
    auto glossy3 = make_shared<metal_ggx>(vec3(1, 1, 1), 0.3);
    ...
    auto glossy4 = make_shared<metal_ggx>(vec3(1, 1, 1), 0.999);
...
hittable_list veach_mis() {
    ...
    auto glossy2 = make_shared<metal_ggx>(vec3(1, 1, 1), 0.20);
    auto glossy3 = make_shared<metal_ggx>(vec3(1, 1, 1), 0.4);
    auto glossy4 = make_shared<metal_ggx>(vec3(1, 0, 0),0.45);
    auto light1 = make_shared<diffuse_light>(color(8, 8, 8));
    auto light2 = make_shared<diffuse_light>(color(4, 4, 4));
    auto light3 = make_shared<diffuse_light>(color(2, 2, 2));
    auto light4 = make_shared<diffuse_light>(color(1, 1, 1));
    ...
    */
    ...
    board3 = make_shared<rotate_y>(board3, 35);//32//33
    board3 = make_shared<translate>(board3, vec3(125, 0, 250));
    objects.add(board3);
...
int main()
{
    ...
    //lights->add(make_shared<sphere>(point3(400, 111, 300), 5, 0));
    //lights->add(make_shared<sphere>(point3(400, 230, 300), 10, 0));
    //lights->add(make_shared<sphere>(point3(400, 333, 300), 20, 0));
    //lights->add(make_shared<sphere>(point3(400, 470, 300), 40, 0));
    ...
    */
    ...
    for (int j = image_height - 1; j >= 0; --j)
    {
        ...
        for (int i = 0; i < image_width; ++i)
        {
            ...
            //auto light_random = lights.random();
            for (int s = 0; s < samples_per_pixel; ++s)
            {
                ...
                rand = dis(gen);
                if (rand == 1)lights->add(make_shared<sphere>(point3(400, 111, 300), 5, shared_ptr<material>()));
                else if (rand == 2)lights->add(make_shared<sphere>(point3(400, 230, 300), 10, shared_ptr<material>()));
                else if (rand == 3)lights->add(make_shared<sphere>(point3(400, 333, 300), 20, shared_ptr<material>()));
                else if (rand == 4)lights->add(make_shared<sphere>(point3(400, 470, 300), 40, shared_ptr<material>()));
